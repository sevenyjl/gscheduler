 ...
 */
package com.gs.cd.gscheduler.server.zk;
...
import com.gs.cd.gscheduler.service.zk.AbstractZKClient;
...
public class ZKMasterClient extends AbstractZKClient {
	...
	public void start() {
		...
		try {
			// create distributed lock with the root node path of the lock space as /gscheduler/lock/failover/master
