 ...
 */
package com.gs.cd.gscheduler.server.worker;
...
import com.gs.cd.gscheduler.server.worker.processor.TaskExecuteProcessor;
import com.gs.cd.gscheduler.server.worker.processor.TaskKillProcessor;
import com.gs.cd.gscheduler.server.worker.registry.WorkerRegistry;
 ...
 *  worker server
 */
@ComponentScan("com.gs.cd.gscheduler")
