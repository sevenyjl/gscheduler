...
//    if (StrUtil.isNotEmpty(desc) && desc.length() > 200) {
...
//  }
    ...
    public static boolean checkOtherParams(String otherParams) {
        return StrUtil.isNotEmpty(otherParams) && !JSONUtil.isJson(otherParams);
    }
    ...
    public static boolean checkPassword(String password) {
        return StrUtil.isNotEmpty(password) && password.length() >= 2 && password.length() <= 20;
    }
    ...
    public static boolean checkPhone(String phone) {
        return StrUtil.isEmpty(phone) || phone.length() == 11;
    }
