...
public class BaseService {
     ...
     * check admin
     *
     * @param JwtUserInfo input JwtUserInfo
     * @return ture if administrator, otherwise return false
     */
    protected boolean isAdmin(JwtUserInfo JwtUserInfo) {
//        return JwtUserInfo.getUserType() == UserType.ADMIN_USER;
        return true;
    }
     ...
     */
    protected boolean checkAdmin(JwtUserInfo loginUser, Map<String, Object> result) {
...
//    }
    ...
    protected boolean hasPerm(JwtUserInfo operateUser, int createUserId) {
        return operateUser.getUserId() == createUserId || isAdmin(operateUser);
    }
}
