 ...
 */
package com.gs.cd.gscheduler.alert.plugin;

import com.gs.cd.gscheduler.alert.manager.EmailManager;
import com.gs.cd.gscheduler.alert.manager.EnterpriseWeChatManager;
import com.gs.cd.gscheduler.alert.utils.Constants;
import com.gs.cd.gscheduler.alert.utils.EnterpriseWeChatUtils;
import com.gs.cd.gscheduler.common.utils.CollectionUtils;
import com.gs.cd.gscheduler.common.utils.StringUtils;
import com.gs.cd.gscheduler.plugin.api.AlertPlugin;
import com.gs.cd.gscheduler.plugin.model.AlertData;
import com.gs.cd.gscheduler.plugin.model.AlertInfo;
import com.gs.cd.gscheduler.plugin.model.PluginName;
